...
export default function EansPage() {
  ...
  return <section className="content products-page"><header className="topbar"><div><p className="eyebrow">Manager panel</p><h1>EAN</h1><p className="products-subtitle">Import and monitor marketplace EAN pools</p></div></header>

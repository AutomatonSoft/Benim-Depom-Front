...
export default function ProductWorkspacePage() {
  ...
  async function loadProduct() {
    ...
    try {
      ...
      setProduct(data); setForm(toForm(data));
    } catch (cause) {
  ...
  async function generateImage(imageId: number) {
    ...
    try {
      ...
      setFeedback("Image generation started. Refresh this page after it completes to view the result."); await loadProduct();
  ...
  async function generateDescription() {
    ...
    try {
      ...
      setGeneration(data as Generation); setFeedback("Description generation started. Its result can be reviewed here once completed.");
